...
if __name__ == '__main__':
    ...
    if (len(sys.argv) < 9):
        ...
        print("Fichas: blancas, negras. Piezas con las que se va a jugar.")
        sys.exit()
        ...
        if fichas != "blancas" and fichas != "negras":      # Solo sirve para el modo de juego "black/white"
            print("\nSorry: fichas incorrectas.")
    ...
    search = Modos_de_Juego(initState, metodo, profundidad, color, max_jugadas, True, fichas)   # True para que jueguen las blancas por defecto.
    search.doSearch()
