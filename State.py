...
class State:
	...
	def calculaHeuristica(self, turno):
		utilidad_b = 0
		utilidad_n = 0
		piezas_b = []
		piezas_n = []
	...
	# Si el estado es final, calculamos que rey falta y devolvemos el valor de utilidad correspondiente.
	def calculaUtilidad(self):
		if 11 not in self.negras:	
			return 90000
